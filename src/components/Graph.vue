<template>
	<section v-if="selectedTicker" class="relative">
			<p>graph in component: {{graph.length}}</p>
...
export default {
  ...
  watch: {
  	selectedTicker(){
      this.$emit('removeGraphElements');
      this.$nextTick(() => this.calculateGraphElements());
    }
  },
  methods: {
      ...
      this.maxGraphTickers = this.$refs.graph.clientWidth / 38;
      console.log('this.maxGraphTickers' + this.maxGraphTickers);
    },
  },
  mounted(){
